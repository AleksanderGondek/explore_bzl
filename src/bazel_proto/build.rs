...
pub mod fileset_entry {
    ...
    impl ::protobuf::Enum for SymlinkBehavior {
        ...
        fn from_str(str: &str) -> ::std::option::Option<SymlinkBehavior> {
            match str {
                "COPY" => ::std::option::Option::Some(SymlinkBehavior::COPY),
                "DEREFERENCE" => ::std::option::Option::Some(SymlinkBehavior::DEREFERENCE),
                _ => ::std::option::Option::None
            }
        }
...
pub struct Attribute {
    ...
    // @@protoc_insertion_point(field:blaze_query.Attribute.source_aspect_name)
    pub source_aspect_name: ::std::option::Option<::std::string::String>,
...
impl Attribute {
    ...
    pub fn source_aspect_name(&self) -> &str {
        match self.source_aspect_name.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_source_aspect_name(&mut self) {
        self.source_aspect_name = ::std::option::Option::None;
    }

    pub fn has_source_aspect_name(&self) -> bool {
        self.source_aspect_name.is_some()
    }

    // Param is passed by value, moved
    pub fn set_source_aspect_name(&mut self, v: ::std::string::String) {
        self.source_aspect_name = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_source_aspect_name(&mut self) -> &mut ::std::string::String {
        if self.source_aspect_name.is_none() {
            self.source_aspect_name = ::std::option::Option::Some(::std::string::String::new());
        }
        self.source_aspect_name.as_mut().unwrap()
    }

    // Take field
    pub fn take_source_aspect_name(&mut self) -> ::std::string::String {
        self.source_aspect_name.take().unwrap_or_else(|| ::std::string::String::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "source_aspect_name",
            |m: &Attribute| { &m.source_aspect_name },
            |m: &mut Attribute| { &mut m.source_aspect_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "type",
            |m: &Attribute| { &m.type_ },
...
impl ::protobuf::Message for Attribute {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                186 => {
                    self.source_aspect_name = ::std::option::Option::Some(is.read_string()?);
                },
                16 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.source_aspect_name.as_ref() {
    ...
    fn default_instance() -> &'static Attribute {
        static instance: Attribute = Attribute {
            ...
            source_aspect_name: ::std::option::Option::None,
...
pub mod attribute {
    ...
    impl ::protobuf::Enum for Discriminator {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Discriminator> {
            match str {
                "INTEGER" => ::std::option::Option::Some(Discriminator::INTEGER),
                "STRING" => ::std::option::Option::Some(Discriminator::STRING),
                "LABEL" => ::std::option::Option::Some(Discriminator::LABEL),
                "OUTPUT" => ::std::option::Option::Some(Discriminator::OUTPUT),
                "STRING_LIST" => ::std::option::Option::Some(Discriminator::STRING_LIST),
                "LABEL_LIST" => ::std::option::Option::Some(Discriminator::LABEL_LIST),
                "OUTPUT_LIST" => ::std::option::Option::Some(Discriminator::OUTPUT_LIST),
                "DISTRIBUTION_SET" => ::std::option::Option::Some(Discriminator::DISTRIBUTION_SET),
                "LICENSE" => ::std::option::Option::Some(Discriminator::LICENSE),
                "STRING_DICT" => ::std::option::Option::Some(Discriminator::STRING_DICT),
                "FILESET_ENTRY_LIST" => ::std::option::Option::Some(Discriminator::FILESET_ENTRY_LIST),
                "LABEL_LIST_DICT" => ::std::option::Option::Some(Discriminator::LABEL_LIST_DICT),
                "STRING_LIST_DICT" => ::std::option::Option::Some(Discriminator::STRING_LIST_DICT),
                "BOOLEAN" => ::std::option::Option::Some(Discriminator::BOOLEAN),
                "TRISTATE" => ::std::option::Option::Some(Discriminator::TRISTATE),
                "INTEGER_LIST" => ::std::option::Option::Some(Discriminator::INTEGER_LIST),
                "UNKNOWN" => ::std::option::Option::Some(Discriminator::UNKNOWN),
                "LABEL_DICT_UNARY" => ::std::option::Option::Some(Discriminator::LABEL_DICT_UNARY),
                "SELECTOR_LIST" => ::std::option::Option::Some(Discriminator::SELECTOR_LIST),
                "LABEL_KEYED_STRING_DICT" => ::std::option::Option::Some(Discriminator::LABEL_KEYED_STRING_DICT),
                "DEPRECATED_STRING_DICT_UNARY" => ::std::option::Option::Some(Discriminator::DEPRECATED_STRING_DICT_UNARY),
                _ => ::std::option::Option::None
            }
        }
    ...
    impl ::protobuf::Enum for Tristate {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Tristate> {
            match str {
                "NO" => ::std::option::Option::Some(Tristate::NO),
                "YES" => ::std::option::Option::Some(Tristate::YES),
                "AUTO" => ::std::option::Option::Some(Tristate::AUTO),
                _ => ::std::option::Option::None
            }
        }
...
pub struct Rule {
    ...
    // @@protoc_insertion_point(field:blaze_query.Rule.rule_class_key)
    pub rule_class_key: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Rule.rule_class_info)
    pub rule_class_info: ::protobuf::MessageField<super::stardoc_output::RuleInfo>,
    // special fields
...
impl Rule {
    ...
    pub fn rule_class_key(&self) -> &str {
        match self.rule_class_key.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_rule_class_key(&mut self) {
        self.rule_class_key = ::std::option::Option::None;
    }

    pub fn has_rule_class_key(&self) -> bool {
        self.rule_class_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set_rule_class_key(&mut self, v: ::std::string::String) {
        self.rule_class_key = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_rule_class_key(&mut self) -> &mut ::std::string::String {
        if self.rule_class_key.is_none() {
            self.rule_class_key = ::std::option::Option::Some(::std::string::String::new());
        }
        self.rule_class_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_rule_class_key(&mut self) -> ::std::string::String {
        self.rule_class_key.take().unwrap_or_else(|| ::std::string::String::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "rule_class_key",
            |m: &Rule| { &m.rule_class_key },
            |m: &mut Rule| { &mut m.rule_class_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::stardoc_output::RuleInfo>(
            "rule_class_info",
            |m: &Rule| { &m.rule_class_info },
            |m: &mut Rule| { &mut m.rule_class_info },
        ));
...
impl ::protobuf::Message for Rule {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                130 => {
                    self.rule_class_key = ::std::option::Option::Some(is.read_string()?);
                },
                138 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.rule_class_info)?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.rule_class_key.as_ref() {
            my_size += ::protobuf::rt::string_size(16, &v);
        }
        if let Some(v) = self.rule_class_info.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
    ...
    fn default_instance() -> &'static Rule {
        static instance: Rule = Rule {
            ...
            rule_class_key: ::std::option::Option::None,
            rule_class_info: ::protobuf::MessageField::none(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
// @@protoc_insertion_point(message:blaze_query.Repository)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Repository {
    // message fields
    // @@protoc_insertion_point(field:blaze_query.Repository.canonical_name)
    pub canonical_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.repo_rule_name)
    pub repo_rule_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.repo_rule_bzl_label)
    pub repo_rule_bzl_label: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.apparent_name)
    pub apparent_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.module_key)
    pub module_key: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.original_name)
    pub original_name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:blaze_query.Repository.attribute)
    pub attribute: ::std::vec::Vec<Attribute>,
    // special fields
    // @@protoc_insertion_point(special_field:blaze_query.Repository.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a Repository {
    fn default() -> &'a Repository {
        <Repository as ::protobuf::Message>::default_instance()
    }
}
...
impl Repository {
    ...
    pub fn canonical_name(&self) -> &str {
        match self.canonical_name.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_canonical_name(&mut self) {
        self.canonical_name = ::std::option::Option::None;
    }
    ...
    // Param is passed by value, moved
    pub fn set_canonical_name(&mut self, v: ::std::string::String) {
        self.canonical_name = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_canonical_name(&mut self) -> &mut ::std::string::String {
        if self.canonical_name.is_none() {
            self.canonical_name = ::std::option::Option::Some(::std::string::String::new());
        }
        self.canonical_name.as_mut().unwrap()
    }

    // Take field
    pub fn take_canonical_name(&mut self) -> ::std::string::String {
        self.canonical_name.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // optional string repo_rule_name = 2;

    pub fn repo_rule_name(&self) -> &str {
        match self.repo_rule_name.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_repo_rule_name(&mut self) {
        self.repo_rule_name = ::std::option::Option::None;
    }

    pub fn has_repo_rule_name(&self) -> bool {
        self.repo_rule_name.is_some()
    }

    // Param is passed by value, moved
    pub fn set_repo_rule_name(&mut self, v: ::std::string::String) {
        self.repo_rule_name = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_repo_rule_name(&mut self) -> &mut ::std::string::String {
        if self.repo_rule_name.is_none() {
            self.repo_rule_name = ::std::option::Option::Some(::std::string::String::new());
        }
        self.repo_rule_name.as_mut().unwrap()
    }

    // Take field
    pub fn take_repo_rule_name(&mut self) -> ::std::string::String {
        self.repo_rule_name.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // optional string repo_rule_bzl_label = 3;

    pub fn repo_rule_bzl_label(&self) -> &str {
        match self.repo_rule_bzl_label.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_repo_rule_bzl_label(&mut self) {
        self.repo_rule_bzl_label = ::std::option::Option::None;
    }

    pub fn has_repo_rule_bzl_label(&self) -> bool {
        self.repo_rule_bzl_label.is_some()
    }

    // Param is passed by value, moved
    pub fn set_repo_rule_bzl_label(&mut self, v: ::std::string::String) {
        self.repo_rule_bzl_label = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_repo_rule_bzl_label(&mut self) -> &mut ::std::string::String {
        if self.repo_rule_bzl_label.is_none() {
            self.repo_rule_bzl_label = ::std::option::Option::Some(::std::string::String::new());
        }
        self.repo_rule_bzl_label.as_mut().unwrap()
    }

    // Take field
    pub fn take_repo_rule_bzl_label(&mut self) -> ::std::string::String {
        self.repo_rule_bzl_label.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // optional string apparent_name = 4;

    pub fn apparent_name(&self) -> &str {
        match self.apparent_name.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_apparent_name(&mut self) {
        self.apparent_name = ::std::option::Option::None;
    }

    pub fn has_apparent_name(&self) -> bool {
        self.apparent_name.is_some()
    }

    // Param is passed by value, moved
    pub fn set_apparent_name(&mut self, v: ::std::string::String) {
        self.apparent_name = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_apparent_name(&mut self) -> &mut ::std::string::String {
        if self.apparent_name.is_none() {
            self.apparent_name = ::std::option::Option::Some(::std::string::String::new());
        }
        self.apparent_name.as_mut().unwrap()
    }

    // Take field
    pub fn take_apparent_name(&mut self) -> ::std::string::String {
        self.apparent_name.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // optional string module_key = 5;

    pub fn module_key(&self) -> &str {
        match self.module_key.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_module_key(&mut self) {
        self.module_key = ::std::option::Option::None;
    }

    pub fn has_module_key(&self) -> bool {
        self.module_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set_module_key(&mut self, v: ::std::string::String) {
        self.module_key = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_module_key(&mut self) -> &mut ::std::string::String {
        if self.module_key.is_none() {
            self.module_key = ::std::option::Option::Some(::std::string::String::new());
        }
        self.module_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_module_key(&mut self) -> ::std::string::String {
        self.module_key.take().unwrap_or_else(|| ::std::string::String::new())
    }

    // optional string original_name = 6;

    pub fn original_name(&self) -> &str {
        match self.original_name.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_original_name(&mut self) {
        self.original_name = ::std::option::Option::None;
    }

    pub fn has_original_name(&self) -> bool {
        self.original_name.is_some()
    }

    // Param is passed by value, moved
    pub fn set_original_name(&mut self, v: ::std::string::String) {
        self.original_name = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_original_name(&mut self) -> &mut ::std::string::String {
        if self.original_name.is_none() {
            self.original_name = ::std::option::Option::Some(::std::string::String::new());
        }
        self.original_name.as_mut().unwrap()
    }

    // Take field
    pub fn take_original_name(&mut self) -> ::std::string::String {
        self.original_name.take().unwrap_or_else(|| ::std::string::String::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "canonical_name",
            |m: &Repository| { &m.canonical_name },
            |m: &mut Repository| { &mut m.canonical_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "repo_rule_name",
            |m: &Repository| { &m.repo_rule_name },
            |m: &mut Repository| { &mut m.repo_rule_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "repo_rule_bzl_label",
            |m: &Repository| { &m.repo_rule_bzl_label },
            |m: &mut Repository| { &mut m.repo_rule_bzl_label },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "apparent_name",
            |m: &Repository| { &m.apparent_name },
            |m: &mut Repository| { &mut m.apparent_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "module_key",
            |m: &Repository| { &m.module_key },
            |m: &mut Repository| { &mut m.module_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "original_name",
            |m: &Repository| { &m.original_name },
            |m: &mut Repository| { &mut m.original_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "attribute",
            |m: &Repository| { &m.attribute },
            |m: &mut Repository| { &mut m.attribute },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<Repository>(
            "Repository",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for Repository {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.canonical_name = ::std::option::Option::Some(is.read_string()?);
                },
                18 => {
                    self.repo_rule_name = ::std::option::Option::Some(is.read_string()?);
                },
                26 => {
                    self.repo_rule_bzl_label = ::std::option::Option::Some(is.read_string()?);
                },
                34 => {
                    self.apparent_name = ::std::option::Option::Some(is.read_string()?);
                },
                42 => {
                    self.module_key = ::std::option::Option::Some(is.read_string()?);
                },
                50 => {
                    self.original_name = ::std::option::Option::Some(is.read_string()?);
                },
                58 => {
                    self.attribute.push(is.read_message()?);
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.canonical_name.as_ref() {
            my_size += ::protobuf::rt::string_size(1, &v);
        }
        if let Some(v) = self.repo_rule_name.as_ref() {
            my_size += ::protobuf::rt::string_size(2, &v);
        }
        if let Some(v) = self.repo_rule_bzl_label.as_ref() {
            my_size += ::protobuf::rt::string_size(3, &v);
        }
        if let Some(v) = self.apparent_name.as_ref() {
            my_size += ::protobuf::rt::string_size(4, &v);
        }
        if let Some(v) = self.module_key.as_ref() {
            my_size += ::protobuf::rt::string_size(5, &v);
        }
        if let Some(v) = self.original_name.as_ref() {
            my_size += ::protobuf::rt::string_size(6, &v);
        }
        for value in &self.attribute {
            let len = value.compute_size();
    ...
    fn default_instance() -> &'static Repository {
        static instance: Repository = Repository {
            canonical_name: ::std::option::Option::None,
            repo_rule_name: ::std::option::Option::None,
            repo_rule_bzl_label: ::std::option::Option::None,
            apparent_name: ::std::option::Option::None,
            module_key: ::std::option::Option::None,
            original_name: ::std::option::Option::None,
            attribute: ::std::vec::Vec::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
...
impl ::protobuf::MessageFull for Repository {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("Repository").unwrap()).clone()
    }
}
...
impl ::protobuf::reflect::ProtobufValue for Repository {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub mod target {
    ...
    impl ::protobuf::Enum for Discriminator {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Discriminator> {
            match str {
                "RULE" => ::std::option::Option::Some(Discriminator::RULE),
                "SOURCE_FILE" => ::std::option::Option::Some(Discriminator::SOURCE_FILE),
                "GENERATED_FILE" => ::std::option::Option::Some(Discriminator::GENERATED_FILE),
                "PACKAGE_GROUP" => ::std::option::Option::Some(Discriminator::PACKAGE_GROUP),
                "ENVIRONMENT_GROUP" => ::std::option::Option::Some(Discriminator::ENVIRONMENT_GROUP),
                _ => ::std::option::Option::None
            }
        }
...
pub mod allowed_rule_class_info {
    ...
    impl ::protobuf::Enum for AllowedRuleClasses {
        ...
        fn from_str(str: &str) -> ::std::option::Option<AllowedRuleClasses> {
            match str {
                "ANY" => ::std::option::Option::Some(AllowedRuleClasses::ANY),
                "SPECIFIED" => ::std::option::Option::Some(AllowedRuleClasses::SPECIFIED),
                _ => ::std::option::Option::None
            }
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1dsrc/main/protobuf/build.proto\x12\x0bblaze_query\x1a&src/main/prot\
    obuf/stardoc_output.proto\"J\n\x07License\x12!\n\x0clicense_type\x18\x01\
    \x20\x03(\tR\x0blicenseType\x12\x1c\n\texception\x18\x02\x20\x03(\tR\tex\
    ception\"9\n\x0fStringDictEntry\x12\x10\n\x03key\x18\x01\x20\x02(\tR\x03\
    ...
    y\x18\x01\x20\x02(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x03(\tR\x05v\
    alue\"C\n\x19LabelKeyedStringDictEntry\x12\x10\n\x03key\x18\x01\x20\x02(\
    \tR\x03key\x12\x14\n\x05value\x18\x02\x20\x02(\tR\x05value\"=\n\x13Strin\
    gListDictEntry\x12\x10\n\x03key\x18\x01\x20\x02(\tR\x03key\x12\x14\n\x05\
    value\x18\x02\x20\x03(\tR\x05value\"\xdb\x02\n\x0cFilesetEntry\x12\x16\n\
    \x06source\x18\x01\x20\x02(\tR\x06source\x123\n\x15destination_directory\
    \x18\x02\x20\x02(\tR\x14destinationDirectory\x12#\n\rfiles_present\x18\
    \x07\x20\x01(\x08R\x0cfilesPresent\x12\x12\n\x04file\x18\x03\x20\x03(\tR\
    \x04file\x12\x18\n\x07exclude\x18\x04\x20\x03(\tR\x07exclude\x12Z\n\x10s\
    ymlink_behavior\x18\x05\x20\x01(\x0e2).blaze_query.FilesetEntry.SymlinkB\
    ehavior:\x04COPYR\x0fsymlinkBehavior\x12!\n\x0cstrip_prefix\x18\x06\x20\
    \x01(\tR\x0bstripPrefix\",\n\x0fSymlinkBehavior\x12\x08\n\x04COPY\x10\
    \x01\x12\x0f\n\x0bDEREFERENCE\x10\x02\"\xcd\x16\n\tAttribute\x12\x12\n\
    \x04name\x18\x01\x20\x02(\tR\x04name\x121\n\x14explicitly_specified\x18\
    \r\x20\x01(\x08R\x13explicitlySpecified\x12\x14\n\x05nodep\x18\x14\x20\
    \x01(\x08R\x05nodep\x12,\n\x12source_aspect_name\x18\x17\x20\x01(\tR\x10\
    sourceAspectName\x128\n\x04type\x18\x02\x20\x02(\x0e2$.blaze_query.Attri\
    bute.DiscriminatorR\x04type\x12\x1b\n\tint_value\x18\x03\x20\x01(\x05R\
    \x08intValue\x12!\n\x0cstring_value\x18\x05\x20\x01(\tR\x0bstringValue\
    \x12#\n\rboolean_value\x18\x0e\x20\x01(\x08R\x0cbooleanValue\x12F\n\x0et\
    ristate_value\x18\x0f\x20\x01(\x0e2\x1f.blaze_query.Attribute.TristateR\
    \rtristateValue\x12*\n\x11string_list_value\x18\x06\x20\x03(\tR\x0fstrin\
    gListValue\x12.\n\x07license\x18\x07\x20\x01(\x0b2\x14.blaze_query.Licen\
    seR\x07license\x12H\n\x11string_dict_value\x18\x08\x20\x03(\x0b2\x1c.bla\
    ze_query.StringDictEntryR\x0fstringDictValue\x12G\n\x12fileset_list_valu\
    e\x18\t\x20\x03(\x0b2\x19.blaze_query.FilesetEntryR\x10filesetListValue\
    \x12R\n\x15label_list_dict_value\x18\n\x20\x03(\x0b2\x1f.blaze_query.Lab\
    elListDictEntryR\x12labelListDictValue\x12U\n\x16string_list_dict_value\
    \x18\x0b\x20\x03(\x0b2\x20.blaze_query.StringListDictEntryR\x13stringLis\
    tDictValue\x12$\n\x0eint_list_value\x18\x11\x20\x03(\x05R\x0cintListValu\
    e\x12U\n\x16label_dict_unary_value\x18\x13\x20\x03(\x0b2\x20.blaze_query\
    .LabelDictUnaryEntryR\x13labelDictUnaryValue\x12h\n\x1dlabel_keyed_strin\
    g_dict_value\x18\x16\x20\x03(\x0b2&.blaze_query.LabelKeyedStringDictEntr\
    yR\x19labelKeyedStringDictValue\x12H\n\rselector_list\x18\x15\x20\x01(\
    \x0b2#.blaze_query.Attribute.SelectorListR\x0cselectorList\x12J\n\"DEPRE\
    CATED_string_dict_unary_value\x18\x12\x20\x03(\x0cR\x1eDEPRECATEDStringD\
    ictUnaryValue\x1a\xcf\x07\n\rSelectorEntry\x12\x14\n\x05label\x18\x01\
    \x20\x01(\tR\x05label\x12(\n\x10is_default_value\x18\x10\x20\x01(\x08R\
    \x0eisDefaultValue\x12\x1b\n\tint_value\x18\x02\x20\x01(\x05R\x08intValu\
    e\x12!\n\x0cstring_value\x18\x03\x20\x01(\tR\x0bstringValue\x12#\n\rbool\
    ean_value\x18\x04\x20\x01(\x08R\x0cbooleanValue\x12F\n\x0etristate_value\
    \x18\x05\x20\x01(\x0e2\x1f.blaze_query.Attribute.TristateR\rtristateValu\
    e\x12*\n\x11string_list_value\x18\x06\x20\x03(\tR\x0fstringListValue\x12\
    .\n\x07license\x18\x07\x20\x01(\x0b2\x14.blaze_query.LicenseR\x07license\
    \x12H\n\x11string_dict_value\x18\x08\x20\x03(\x0b2\x1c.blaze_query.Strin\
    gDictEntryR\x0fstringDictValue\x12G\n\x12fileset_list_value\x18\t\x20\
    \x03(\x0b2\x19.blaze_query.FilesetEntryR\x10filesetListValue\x12R\n\x15l\
    abel_list_dict_value\x18\n\x20\x03(\x0b2\x1f.blaze_query.LabelListDictEn\
    tryR\x12labelListDictValue\x12U\n\x16string_list_dict_value\x18\x0b\x20\
    \x03(\x0b2\x20.blaze_query.StringListDictEntryR\x13stringListDictValue\
    \x12$\n\x0eint_list_value\x18\r\x20\x03(\x05R\x0cintListValue\x12U\n\x16\
    label_dict_unary_value\x18\x0f\x20\x03(\x0b2\x20.blaze_query.LabelDictUn\
    aryEntryR\x13labelDictUnaryValue\x12h\n\x1dlabel_keyed_string_dict_value\
    \x18\x11\x20\x03(\x0b2&.blaze_query.LabelKeyedStringDictEntryR\x19labelK\
    eyedStringDictValue\x12J\n\"DEPRECATED_string_dict_unary_value\x18\x0e\
    \x20\x03(\x0cR\x1eDEPRECATEDStringDictUnaryValueJ\x04\x08\x0c\x10\r\x1a\
    \x9c\x01\n\x08Selector\x12>\n\x07entries\x18\x01\x20\x03(\x0b2$.blaze_qu\
    ery.Attribute.SelectorEntryR\x07entries\x12*\n\x11has_default_value\x18\
    \x02\x20\x01(\x08R\x0fhasDefaultValue\x12$\n\x0eno_match_error\x18\x03\
    \x20\x01(\tR\x0cnoMatchError\x1a\x85\x01\n\x0cSelectorList\x128\n\x04typ\
    e\x18\x01\x20\x01(\x0e2$.blaze_query.Attribute.DiscriminatorR\x04type\
    \x12;\n\x08elements\x18\x02\x20\x03(\x0b2\x1f.blaze_query.Attribute.Sele\
    ctorR\x08elements\"\x8a\x03\n\rDiscriminator\x12\x0b\n\x07INTEGER\x10\
    \x01\x12\n\n\x06STRING\x10\x02\x12\t\n\x05LABEL\x10\x03\x12\n\n\x06OUTPU\
    T\x10\x04\x12\x0f\n\x0bSTRING_LIST\x10\x05\x12\x0e\n\nLABEL_LIST\x10\x06\
    \x12\x0f\n\x0bOUTPUT_LIST\x10\x07\x12\x14\n\x10DISTRIBUTION_SET\x10\x08\
    \x12\x0b\n\x07LICENSE\x10\t\x12\x0f\n\x0bSTRING_DICT\x10\n\x12\x16\n\x12\
    FILESET_ENTRY_LIST\x10\x0b\x12\x13\n\x0fLABEL_LIST_DICT\x10\x0c\x12\x14\
    \n\x10STRING_LIST_DICT\x10\r\x12\x0b\n\x07BOOLEAN\x10\x0e\x12\x0c\n\x08T\
    RISTATE\x10\x0f\x12\x10\n\x0cINTEGER_LIST\x10\x10\x12\x0b\n\x07UNKNOWN\
    \x10\x12\x12\x14\n\x10LABEL_DICT_UNARY\x10\x13\x12\x11\n\rSELECTOR_LIST\
    \x10\x14\x12\x1b\n\x17LABEL_KEYED_STRING_DICT\x10\x15\x12\x20\n\x1cDEPRE\
    CATED_STRING_DICT_UNARY\x10\x11\"%\n\x08Tristate\x12\x06\n\x02NO\x10\0\
    \x12\x07\n\x03YES\x10\x01\x12\x08\n\x04AUTO\x10\x02J\x04\x08\x0c\x10\rJ\
    \x04\x08\x10\x10\x11\"\xd2\x05\n\x04Rule\x12\x12\n\x04name\x18\x01\x20\
    \x02(\tR\x04name\x12\x1d\n\nrule_class\x18\x02\x20\x02(\tR\truleClass\
    \x12\x1a\n\x08location\x18\x03\x20\x01(\tR\x08location\x124\n\tattribute\
    \x18\x04\x20\x03(\x0b2\x16.blaze_query.AttributeR\tattribute\x12\x1d\n\n\
    rule_input\x18\x05\x20\x03(\tR\truleInput\x12T\n\x15configured_rule_inpu\
    t\x18\x0f\x20\x03(\x0b2\x20.blaze_query.ConfiguredRuleInputR\x13configur\
    edRuleInput\x12\x1f\n\x0brule_output\x18\x06\x20\x03(\tR\nruleOutput\x12\
    '\n\x0fdefault_setting\x18\x07\x20\x03(\tR\x0edefaultSetting\x12?\n\x1cD\
    EPRECATED_public_by_default\x18\t\x20\x01(\x08R\x19DEPRECATEDPublicByDef\
    ault\x122\n\x15DEPRECATED_is_skylark\x18\n\x20\x01(\x08R\x13DEPRECATEDIs\
    Skylark\x12A\n\x1dskylark_environment_hash_code\x18\x0c\x20\x01(\tR\x1as\
    kylarkEnvironmentHashCode\x12/\n\x13instantiation_stack\x18\r\x20\x03(\t\
    R\x12instantiationStack\x12)\n\x10definition_stack\x18\x0e\x20\x03(\tR\
    \x0fdefinitionStack\x12$\n\x0erule_class_key\x18\x10\x20\x01(\tR\x0crule\
    ClassKey\x12@\n\x0frule_class_info\x18\x11\x20\x01(\x0b2\x18.stardoc_out\
    put.RuleInfoR\rruleClassInfoJ\x04\x08\x08\x10\tJ\x04\x08\x0b\x10\x0c\"\
    \xa7\x02\n\nRepository\x12%\n\x0ecanonical_name\x18\x01\x20\x01(\tR\rcan\
    onicalName\x12$\n\x0erepo_rule_name\x18\x02\x20\x01(\tR\x0crepoRuleName\
    \x12-\n\x13repo_rule_bzl_label\x18\x03\x20\x01(\tR\x10repoRuleBzlLabel\
    \x12#\n\rapparent_name\x18\x04\x20\x01(\tR\x0capparentName\x12\x1d\n\nmo\
    dule_key\x18\x05\x20\x01(\tR\tmoduleKey\x12#\n\roriginal_name\x18\x06\
    \x20\x01(\tR\x0coriginalName\x124\n\tattribute\x18\x07\x20\x03(\x0b2\x16\
    .blaze_query.AttributeR\tattribute\"\x8d\x01\n\x13ConfiguredRuleInput\
    \x12\x14\n\x05label\x18\x01\x20\x01(\tR\x05label\x125\n\x16configuration\
    _checksum\x18\x02\x20\x01(\tR\x15configurationChecksum\x12)\n\x10configu\
    ration_id\x18\x03\x20\x01(\rR\x0fconfigurationId\"\x83\x01\n\x0bRuleSumm\
    ary\x12%\n\x04rule\x18\x01\x20\x02(\x0b2\x11.blaze_query.RuleR\x04rule\
    \x121\n\ndependency\x18\x02\x20\x03(\x0b2\x11.blaze_query.RuleR\ndepende\
    ncy\x12\x1a\n\x08location\x18\x03\x20\x01(\tR\x08location\"\x8b\x01\n\
    \x0cPackageGroup\x12\x12\n\x04name\x18\x01\x20\x02(\tR\x04name\x12+\n\
    \x11contained_package\x18\x02\x20\x03(\tR\x10containedPackage\x124\n\x16\
    included_package_group\x18\x03\x20\x03(\tR\x14includedPackageGroupJ\x04\
    \x08\x04\x10\x05\"b\n\x10EnvironmentGroup\x12\x12\n\x04name\x18\x01\x20\
    \x02(\tR\x04name\x12\x20\n\x0benvironment\x18\x02\x20\x03(\tR\x0benviron\
    ment\x12\x18\n\x07default\x18\x03\x20\x03(\tR\x07default\"\xb4\x02\n\nSo\
    urceFile\x12\x12\n\x04name\x18\x01\x20\x02(\tR\x04name\x12\x1a\n\x08loca\
    tion\x18\x02\x20\x01(\tR\x08location\x12\x1e\n\nsubinclude\x18\x03\x20\
    \x03(\tR\nsubinclude\x12#\n\rpackage_group\x18\x04\x20\x03(\tR\x0cpackag\
    eGroup\x12)\n\x10visibility_label\x18\x05\x20\x03(\tR\x0fvisibilityLabel\
    \x12\x18\n\x07feature\x18\x06\x20\x03(\tR\x07feature\x12.\n\x07license\
    \x18\x08\x20\x01(\x0b2\x14.blaze_query.LicenseR\x07license\x126\n\x17pac\
    kage_contains_errors\x18\t\x20\x01(\x08R\x15packageContainsErrorsJ\x04\
    \x08\x07\x10\x08\"h\n\rGeneratedFile\x12\x12\n\x04name\x18\x01\x20\x02(\
    \tR\x04name\x12'\n\x0fgenerating_rule\x18\x02\x20\x02(\tR\x0egeneratingR\
    ule\x12\x1a\n\x08location\x18\x03\x20\x01(\tR\x08location\"\xd9\x03\n\
    \x06Target\x125\n\x04type\x18\x01\x20\x02(\x0e2!.blaze_query.Target.Disc\
    riminatorR\x04type\x12%\n\x04rule\x18\x02\x20\x01(\x0b2\x11.blaze_query.\
    RuleR\x04rule\x128\n\x0bsource_file\x18\x03\x20\x01(\x0b2\x17.blaze_quer\
    y.SourceFileR\nsourceFile\x12A\n\x0egenerated_file\x18\x04\x20\x01(\x0b2\
    \x1a.blaze_query.GeneratedFileR\rgeneratedFile\x12>\n\rpackage_group\x18\
    \x05\x20\x01(\x0b2\x19.blaze_query.PackageGroupR\x0cpackageGroup\x12J\n\
    \x11environment_group\x18\x06\x20\x01(\x0b2\x1d.blaze_query.EnvironmentG\
    roupR\x10environmentGroup\"h\n\rDiscriminator\x12\x08\n\x04RULE\x10\x01\
    \x12\x0f\n\x0bSOURCE_FILE\x10\x02\x12\x12\n\x0eGENERATED_FILE\x10\x03\
    \x12\x11\n\rPACKAGE_GROUP\x10\x04\x12\x15\n\x11ENVIRONMENT_GROUP\x10\x05\
    \":\n\x0bQueryResult\x12+\n\x06target\x18\x01\x20\x03(\x0b2\x13.blaze_qu\
    ery.TargetR\x06target\"\xc0\x01\n\x14AllowedRuleClassInfo\x12L\n\x06poli\
    cy\x18\x01\x20\x02(\x0e24.blaze_query.AllowedRuleClassInfo.AllowedRuleCl\
    assesR\x06policy\x12,\n\x12allowed_rule_class\x18\x02\x20\x03(\tR\x10all\
    owedRuleClass\",\n\x12AllowedRuleClasses\x12\x07\n\x03ANY\x10\x01\x12\r\
    \n\tSPECIFIED\x10\x02\"\xfa\x03\n\x13AttributeDefinition\x12\x12\n\x04na\
    me\x18\x01\x20\x02(\tR\x04name\x128\n\x04type\x18\x02\x20\x02(\x0e2$.bla\
    ze_query.Attribute.DiscriminatorR\x04type\x12\x1c\n\tmandatory\x18\x03\
    \x20\x01(\x08R\tmandatory\x12S\n\x14allowed_rule_classes\x18\x04\x20\x01\
    (\x0b2!.blaze_query.AllowedRuleClassInfoR\x12allowedRuleClasses\x12$\n\r\
    documentation\x18\x05\x20\x01(\tR\rdocumentation\x12\x1f\n\x0ballow_empt\
    y\x18\x06\x20\x01(\x08R\nallowEmpty\x12*\n\x11allow_single_file\x18\x07\
    \x20\x01(\x08R\x0fallowSingleFile\x125\n\x07default\x18\t\x20\x01(\x0b2\
    \x1b.blaze_query.AttributeValueR\x07default\x12\x1e\n\nexecutable\x18\n\
    \x20\x01(\x08R\nexecutable\x12\"\n\x0cconfigurable\x18\x0b\x20\x01(\x08R\
    \x0cconfigurable\x12\x14\n\x05nodep\x18\x0c\x20\x01(\x08R\x05nodep\x12\
    \x1e\n\x0bcfg_is_host\x18\r\x20\x01(\x08R\tcfgIsHost\"\x8c\x02\n\x0eAttr\
    ibuteValue\x12\x10\n\x03int\x18\x01\x20\x01(\x05R\x03int\x12\x16\n\x06st\
    ring\x18\x02\x20\x01(\tR\x06string\x12\x12\n\x04bool\x18\x03\x20\x01(\
    \x08R\x04bool\x12/\n\x04list\x18\x04\x20\x03(\x0b2\x1b.blaze_query.Attri\
    buteValueR\x04list\x129\n\x04dict\x18\x05\x20\x03(\x0b2%.blaze_query.Att\
    ributeValue.DictEntryR\x04dict\x1aP\n\tDictEntry\x12\x10\n\x03key\x18\
    \x01\x20\x02(\tR\x03key\x121\n\x05value\x18\x02\x20\x02(\x0b2\x1b.blaze_\
    query.AttributeValueR\x05value\"\xa0\x01\n\x0eRuleDefinition\x12\x12\n\
    \x04name\x18\x01\x20\x02(\tR\x04name\x12>\n\tattribute\x18\x02\x20\x03(\
    \x0b2\x20.blaze_query.AttributeDefinitionR\tattribute\x12$\n\rdocumentat\
    ion\x18\x03\x20\x01(\tR\rdocumentation\x12\x14\n\x05label\x18\x04\x20\
    \x01(\tR\x05label\"@\n\rBuildLanguage\x12/\n\x04rule\x18\x01\x20\x03(\
    \x0b2\x1b.blaze_query.RuleDefinitionR\x04ruleB6\n4com.google.devtools.bu\
    ild.lib.query2.proto.proto2api\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::stardoc_output::file_descriptor().clone());
            ...
            messages.push(Repository::generated_message_descriptor_data());
